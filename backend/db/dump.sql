...
ALTER TABLE `UserToFlatshare` ADD CONSTRAINT `UserToFlatshare_fk0` FOREIGN KEY (`user_id`) REFERENCES `User`(`id`);

ALTER TABLE `UserToFlatshare` ADD CONSTRAINT `UserToFlatshare_fk1` FOREIGN KEY (`flatshare_id`) REFERENCES `Flatshare`(`id`);

ALTER TABLE `Expense` ADD CONSTRAINT `Expense_fk0` FOREIGN KEY (`paying_one_id`) REFERENCES `User`(`id`);
